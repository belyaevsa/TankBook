...
|---|---|---|---|---|
| `RV.275` | J1, J13 | flash | 99555 | the car's photo on the Garage list and the switcher |
| `RV.277` | J7b, F1 | flash | (re-dispatching, widened: the expense corpus joins the ratchet, `recognised.csv`, the spike runs the folder) | beside RV.275 |
