...
|---|---|---|---|---|
| `RV.276` | F9a, J3 | flash | 38165 | two fill-ups at one reading on one day |
| `RV.278` | J7b | flash | 38166 | the expense corpus scores the photograph (spike + core tests only, beside RV.276) |
