...
|---|---|---|---|---|
| `RV.256` | J11, J11a | flash | 37772 | persisted sync state keyed by account |
| `REVIEW-SCENARIO-F6b` | F6b | pro | 37771 | walk after RV.229 |
| `REVIEW-SCENARIO-F2` | F2 | pro | 39966 | walk after RV.243 + RV.229 |
