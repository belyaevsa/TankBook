...
|---|---|---|---|---|
| `RV.280` | J7b, J3, J10 | flash | 28596 | the late expense read carries the receipt's currency |
| `PJ.29` | J7b, J7, F4, J3 | flash | (next - after RV.280 lands; builds on its `ExpenseRecognition.currency`) | every scanned document reaches the cloud gateway |
