...
| `REVIEW-F9a-3` | F9a | pro, read-only | 42545 | second walk after `RV.230` + `RV.231` (`70e7309`) |
...
**Already implemented:** `F3`, `J5`, `F5`, `F8`, `F6b`, `F2`, `F1`, `J8` (2026-09-11). **Ready for review with no v1 rows open:** `F4`, `F6a`,
