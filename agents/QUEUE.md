...
|---|---|---|---|---|
| RV.286 | J11a / F10 - sign-in during the deletion grace reactivates | deepseek-v4-flash | 25194 | `agents/briefs/RV.286.md` |
| RV.181 | J13 / J8b - the diagnostics share as a file (device report: AirDrop yes, Telegram no) | deepseek-v4-flash | 27041 | `agents/briefs/RV.181.md` |
