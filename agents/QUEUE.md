...
|---|---|---|---|---|
| `RV.276` | F9a, J3 | flash | (dispatching) | two fill-ups at one reading on one day |
| `RV.278` | J7b | flash | (dispatching) | the expense corpus scores the photograph (spike + core tests only, beside RV.276) |
