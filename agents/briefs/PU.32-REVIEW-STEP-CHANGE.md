...
**Read-only.** You write exactly ONE file: `agents/reviews/PU.32-REVIEW-STEP-CHANGE-<model>.md`,
where `<model>` is the short name of the model you are (`qwen` or `deepseek`). No code. No `/tmp`.
