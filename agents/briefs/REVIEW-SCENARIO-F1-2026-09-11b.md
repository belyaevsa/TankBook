# REVIEW-SCENARIO run: F1 - 2026-09-11b (first walk)

- **Scenario:** `F1` (`docs/JOURNEYS.md`)
- **Run id:** REVIEW-SCENARIO-F1-2026-09-11b
- **Report path:** `diagnostics/REVIEW-SCENARIO-F1-2026-09-11b.md`
- **Rows that named it:** closed - `RV.164` shipped 9cac6dbd and the five earlier F1 rows in TASKS-DONE. No open v1 row.
