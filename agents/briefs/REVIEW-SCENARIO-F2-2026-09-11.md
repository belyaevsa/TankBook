# REVIEW-SCENARIO run: F2 - 2026-09-11

- **Scenario:** `F2` - Scan recognized wrong data - the most dangerous failure (`docs/JOURNEYS.md`)
- **Rows that named it:** (see scripts/scenario-index.py - one closed row)
- **Adjacent scenarios it hands off to or from:** J3, J3b, F1, J8b
- **Run id:** REVIEW-SCENARIO-F2-2026-09-11
- **Report path:** `diagnostics/REVIEW-SCENARIO-F2-2026-09-11.md`
