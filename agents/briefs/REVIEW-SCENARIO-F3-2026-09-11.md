# REVIEW-SCENARIO run: F3 - 2026-09-11

- **Scenario:** `F3` - No internet at the pump (`docs/JOURNEYS.md`)
- **Rows that named it:** PJ.19 (closed); SH.3 is the owner's own launch walk, not a build row
- **Adjacent scenarios it hands off to or from:** J3, F4, J3b
- **Run id:** REVIEW-SCENARIO-F3-2026-09-11
- **Report path:** `diagnostics/REVIEW-SCENARIO-F3-2026-09-11.md`
