# REVIEW-SCENARIO run: F5 - 2026-09-11

- **Scenario:** `F5` - The receipt's QR decodes, and nothing more is fetched (P3) (`docs/JOURNEYS.md`)
- **Rows that named it:** PJ.47 (closed)
- **Adjacent scenarios it hands off to or from:** J5, J3
- **Run id:** REVIEW-SCENARIO-F5-2026-09-11
- **Report path:** `diagnostics/REVIEW-SCENARIO-F5-2026-09-11.md`
