...
- **Scenario:** `F6a` (`docs/JOURNEYS.md`)
- **Run id:** REVIEW-SCENARIO-F6a-2026-09-11c
- **Report path:** `diagnostics/REVIEW-SCENARIO-F6a-2026-09-11c.md`
- **Context:** First walk. Every v1 row closed; PJ.44 is [v1.1] and not blocking - mark it N/A.
