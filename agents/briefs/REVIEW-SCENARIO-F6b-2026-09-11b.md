# REVIEW-SCENARIO run: F6b - 2026-09-11b (second walk, after RV.220+RV.221+RV.191)

- **Scenario:** `F6b` (`docs/JOURNEYS.md`)
- **Run id:** REVIEW-SCENARIO-F6b-2026-09-11b
- **Report path:** `diagnostics/REVIEW-SCENARIO-F6b-2026-09-11b.md`
- **What changed since the first walk:** `RV.220`, `RV.221`, `RV.191` (commit 7d4e1fc6). Read `diagnostics/REVIEW-SCENARIO-F6b-2026-09-11.md` first; re-check ONLY its MISSING/PARTIAL rows plus the sequence trace.
