# REVIEW-SCENARIO run: F8 - 2026-09-11

- **Scenario:** `F8` - Permissions and hardware said no (`docs/JOURNEYS.md`)
- **Rows that named it:** PJ.6 (closed) and one more - see scripts/scenario-index.py
- **Adjacent scenarios it hands off to or from:** J3, J3b, J4
- **Run id:** REVIEW-SCENARIO-F8-2026-09-11
- **Report path:** `diagnostics/REVIEW-SCENARIO-F8-2026-09-11.md`
