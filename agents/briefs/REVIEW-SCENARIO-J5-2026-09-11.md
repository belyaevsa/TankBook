...
- **Scenario:** `J5` - The RU/KZ receipt (P3) - the fiscal QR as an anchor, never a feature (`docs/JOURNEYS.md`)
- **Rows that named it:** (see scripts/scenario-index.py - one closed row)
- **Adjacent scenarios it hands off to or from:** J3, F5
- **Run id:** REVIEW-SCENARIO-J5-2026-09-11
- **Report path:** `diagnostics/REVIEW-SCENARIO-J5-2026-09-11.md`
