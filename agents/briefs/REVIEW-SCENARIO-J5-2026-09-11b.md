...
- **Report path:** `diagnostics/REVIEW-SCENARIO-J5-2026-09-11b.md`
- **What changed since the first walk:** `RV.219` (commit 96d05ae2) - the assembler passes the QR anchor into `extract`, so the QR date now lands. Read `diagnostics/REVIEW-SCENARIO-J5-2026-09-11.md` first and re-check ONLY what it found MISSING or PARTIAL, plus the sequence trace. Every v1 row naming this scenario is now closed.
