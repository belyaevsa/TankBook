...
- **Scenario:** `J7d` (`docs/JOURNEYS.md`)
- **Run id:** REVIEW-SCENARIO-J7d-2026-09-12
- **Report path:** `diagnostics/REVIEW-SCENARIO-J7d-2026-09-12.md`
- **Context:** first walk. The heading is [v1.1] but the offer shipped in v1 (`PJ.22`, `RV.213`, `PJ.27`). Walk what the text promises against the tree; `PJ.60` is the one open row and awaits the owner.
