...
Only this one path, inside the worktree you are started in:
    ...
    diagnostics/RV.48-proposal-glm.md

**This is your run's THIRD attempt, narrowed.** Two earlier runs on the wider brief reasoned to
the end of their budget and saved almost nothing. So: **answer only questions 1 and 3** (the
...
Write `diagnostics/RV.48-proposal-glm.md` as a **ranked list of concrete changes**, most valuable
