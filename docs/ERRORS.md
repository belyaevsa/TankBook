...
| Below data floor | Honest label: "first estimate · 1 fill cycle" / extended window "last 5 months". **RV.118 (2026-09-19): every headline carries its provenance line** - "6 fills · last 90 days · 4 full tanks" on Home under the figure and as the Trends consumption tile's caption (the tile's caption is the provenance when the car has fills, the honest span label otherwise); a car with fills but no closed segment reads "Not enough data yet · 2 fills · 1 full tank" beside the D4 hint - the count it has, never a computed average. Three whole localised count phrases (real plural rules) joined by a middle dot, never a count glued to a word | Keep logging; the line says what the number is made of |
