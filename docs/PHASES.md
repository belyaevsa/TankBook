...
## P1 · Local core loop (a usable app, no camera, no server) – **COMPLETE**
...
## P2 · Capture (the hero) – **effectively complete**: P2.4/P2.6/P2.7 are `[~]` on facts, not effort, and P2.8 is `[cut]` (the on-device model has no Russian)
