...
**Totals: 24 pro, 20 flash** across the 44 build dispatches of 2026-09-03/05; **every build dispatch since 2026-09-10 ran on flash** (the 2026-09-12 block below: 34 dispatches, 58 rows, pro used only for the read-only scenario and journeys walks - 14 of them that day, not in this ledger; the 2026-09-13 block: 12 dispatches, 13 rows, every walk run by the orchestrator). Read it with the selection bias in mind -
