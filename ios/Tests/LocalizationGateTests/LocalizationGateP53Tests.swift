...
struct LocalizationGateP53Tests {
    ...
    private static let pluralCases: [(String, [Int: String])] = [
            ...
            ("Save fill-up + %lld expenses", [1: "Сохранить заправку + 1 затрата",
                                              2: "Сохранить заправку + 2 затраты",
                                              5: "Сохранить заправку + 5 затрат",
                                              11: "Сохранить заправку + 11 затрат",
                                              21: "Сохранить заправку + 21 затрата"]),
