...
let entities: [String: ([String: Any], [String])] = [
    "vehicle": (vehicleProperties, ["id", "createdAt", "updatedAt", "name", "powertrain", "fuelKinds", "homeCurrency", "units", "archived", "paceLimitKmPerDay"]),
    "fillUp": (fillUpProperties, ["id", "createdAt", "updatedAt", "vehicleId", "date", "attachments", "provenance", "conflict", "volumeL", "fuelKind", "isFull", "crossCheck"]),
    "chargeSession": (chargeSessionProperties, ["id", "createdAt", "updatedAt", "vehicleId", "date", "attachments", "provenance", "conflict", "energyKWh", "chargeType"]),
    "serviceRecord": (serviceRecordProperties, ["id", "createdAt", "updatedAt", "vehicleId", "date", "attachments", "provenance", "conflict", "items", "usedParts"]),
    "expense": (expenseProperties, ["id", "createdAt", "updatedAt", "vehicleId", "date", "attachments", "provenance", "conflict", "category", "title"]),
